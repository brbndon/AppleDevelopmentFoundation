...
1. `session_show_defaults` (XcodeBuildMCP) — report project, scheme, configuration, simulator.
2. Resolve and reuse **one exact simulator ID**. Do **not** use `OS=latest`.
3. Build and install/launch the app with XcodeBuildMCP.
4. Inspect the screen (Maestro MCP and/or hierarchy tools) before editing selectors.
