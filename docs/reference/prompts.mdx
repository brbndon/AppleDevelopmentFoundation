...
Constraints:
- Use $codex-bootstrap and sibling skills from /path/to/AppleDevelopmentFoundation/.agents/skills.
...
Verification: session_show_defaults → build_run_sim (prefer) → test_sim if present → optional screenshot/snapshot_ui.
```
