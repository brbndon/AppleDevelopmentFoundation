...
3. For UI: install/launch on the pinned simulator, then run Maestro flows  
4. On failure: logs/hierarchy/screenshot → fix → re-run the smallest failing slice  
5. Report scheme, device ID, commands, pass/fail, residual risk  
