...
| `swift-testing-verification` | “Run the right checks after this public SwiftUI API change.”; “Verify a user-visible iOS/iPadOS change with its UI inspection contract.” | “Plan test coverage before coding.”; “Write a feature plan.” | Overlaps all implementation skills; use `$swift-testing-verification` after a change. | Consumer workspace |
