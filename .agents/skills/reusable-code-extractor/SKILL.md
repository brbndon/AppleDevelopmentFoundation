...
Target the consumer's shared module or Swift package — not AppleDevelopmentFoundation `Sources/` unless the user explicitly asked to work on that archived package.
