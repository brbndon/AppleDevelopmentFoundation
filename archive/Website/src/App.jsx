  ...
  return (
    <section id="modules" className="section-shell section-block modules-section">
      ...
      <div className="section-intro split-intro" style={{ marginTop: "4rem" }}>
        ...
        <p>
          The Swift package under <code>archive/Sources/</code> is archived exploratory work — not the live product.
          See <code>ARCHIVE.md</code> and <code>archive/Documentation/Modules.md</code> for historical module boundaries.
    ...
    <section id="agents" className="agent-section">
      <div className="shell section-block">
        ...
        <div className="agent-grid">
          ...
          <article className="agent-card"><span>02</span><h3>Skill invocation</h3><p>Use <code>$codex-bootstrap</code> for new projects, then layer design, component, and review skills. Skills target the active workspace, not <code>archive/Sources/</code> here.</p></article>
  ...
  return (
    <section id="ownership" className="section-shell section-block ownership-section">
      ...
      <div className="ownership-grid">
        <div className="ownership-column owns"><div className="ownership-heading"><span aria-hidden="true">+</span><h3>Live product</h3></div><ul><li><code>.agents/skills/</code> — reusable Codex skills</li><li><code>MCP.md</code> — XcodeBuildMCP and prompts</li><li><code>README.md</code> and <code>AGENTS.md</code> — entry points</li><li><code>docs/skills/skill-authoring-guide.mdx</code> — skill maintenance</li><li>Verification: <code>verify-skills.sh</code>, <code>test-install-skills.sh</code></li></ul></div>
        <div className="ownership-column app-owns"><div className="ownership-heading"><span aria-hidden="true">→</span><h3>Archived reference</h3></div><ul><li><code>archive/Sources/</code>, <code>archive/Tests/</code>, <code>archive/Package.swift</code></li><li><code>archive/Documentation/</code> package guides</li><li><code>archive/Apps/</code>, <code>archive/Examples/</code>, this website&apos;s package section</li><li><code>archive/Scripts/verify.sh</code> — only when working on archived code</li><li>Do not add as a dependency without explicit intent</li></ul></div>
      </div>
    </section>
  );
}
    ...
    <section className="section-shell section-block docs-section">
      <div className="docs-card">
        ...
        <div className="docs-links">
          ...
          <span>docs/skills/skill-authoring-guide.mdx — maintain skills</span>
