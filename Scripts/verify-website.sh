...
rg -q 'id="guide"' "$WEBSITE_DIR/src/App.jsx"
rg -q 'id="guide-template"' "$WEBSITE_DIR/src/App.jsx"
rg -q 'id="workflow"' "$WEBSITE_DIR/src/App.jsx"
rg -q 'id="workflow-scenarios"' "$WEBSITE_DIR/src/App.jsx"
rg -q 'id="workflow-map"' "$WEBSITE_DIR/src/App.jsx"
rg -q 'Interactive execution trace' "$WEBSITE_DIR/src/App.jsx"
rg -q 'Agent guide' "$WEBSITE_DIR/src/App.jsx"
rg -q 'swiftui-tab-navigation' "$WEBSITE_DIR/src/App.jsx"
rg -q 'Thirteen focused skills' "$WEBSITE_DIR/src/App.jsx"
